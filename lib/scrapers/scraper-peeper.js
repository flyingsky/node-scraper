...
ScraperPeeper.prototype.getCityList = function(baseUrl, callback) {
  ...
  var opts = {parser: new HomePageParser(baseUrl)};
  me.scraper.scrapePage(baseUrl, opts, function(err, result) {
    if(err) {
      callback(err, result);
    } else {
...
ScraperPeeper.prototype.scrapCityPage = function(baseUrl, callback) {
  ...
  var opts = {parser: new CityPageParser(baseUrl)};
  me.scraper.scrapePage(baseUrl, opts, function(err, result) {
    if(err) {
      callback(err, result);
    } else {
...
ScraperPeeper.prototype.scrapeImagePage = function(baseUrl, callback) {
  ...
  var opts = {parser: new ImagePageParser(baseUrl)};
  me.scraper.scrapePage(baseUrl, opts, function(err, result) {
    if(err) {
      callback(err, result);
    } else {
...
HomePageParser.prototype.parse = function(data) {
  var me = this;
...
CityPageParser.prototype.parse = function(data) {
  var me = this;
  var $ = cheerio.load(data);
...
ImagePageParser.prototype.parse = function(data) {
  var me = this;
  var $ = cheerio.load(data);
